...
class SecurityScanner {
    ...
    checkWeakCrypto(line, file, lineNumber) {
        ...
        const cryptoPatterns = [
            { pattern: /md5\s*\(/i, type: 'MD5', severity: 'HIGH' },
            { pattern: /sha1\s*\(/i, type: 'SHA1', severity: 'MEDIUM' },
            { pattern: /Math\.random\s*\(/i, type: 'Math.random', severity: 'MEDIUM' },
            { pattern: /DES|3DES/i, type: 'DES/3DES', severity: 'HIGH' },
            { pattern: /RC4/i, type: 'RC4', severity: 'HIGH' }
        ];
